...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  mEmail = (EditText) findViewById(R.id.edit_email_register);
       ...
       // mRegister = (Button) findViewById(R.id.btn_register);
            ...
            public void onSuccess(final LoginResult loginResult) {
                ...
                GraphRequest request = GraphRequest.newMeRequest(loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
                    ...
                    public void onCompleted(JSONObject object, GraphResponse response) {
                        ...
                        Intent i = new Intent(new Intent(Register.this, OnLoginSuccessful.class));
                        ...
                        i.putExtra("uid", uid);
                        startActivity(i);
                        Toast.makeText(Register.this, bFacebookData.getString("email")+""+bFacebookData.getString("first_name"), Toast.LENGTH_SHORT).show();
        ...
        mLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Register.this, MailAccount.class);
  ...
  /*  public void startSignIn() {
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Register.this, "Login Failed:" + task.getException(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private Bundle getFacebookData(JSONObject object) {
        ...
        try {
            ...
            Toast.makeText(Register.this,object.getString("email")+object.getString("last_name")+ "", Toast.LENGTH_SHORT).show();
